...
export function legacyCheckpointPath(cwd) {
...
export function migrateLegacyCheckpointIfNeeded(cwd) {
...
export function readLegacyCheckpointRaw(cwd) {
    const legacy = legacyCheckpointPath(cwd);
    if (!existsSync(legacy))
        return null;
    try {
...
//# sourceMappingURL=checkpoint-legacy.js.map