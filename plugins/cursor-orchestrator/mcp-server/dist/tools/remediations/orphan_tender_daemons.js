...
import { classifyOrphans, parseTenderDaemonProcesses, parseTmuxSessions, } from '../../checks/orphan-tender-daemons.js';
 ...
 */
export async function remediateOrphanDaemons(opts) {
...
async function listOrphanPids(ctx) {
    ...
    try {
        ...
        if (tmux.code === 0)
            live = parseTmuxSessions(tmux.stdout);
    }
    catch {
...
export const orphanTenderDaemonsHandler = {
...
//# sourceMappingURL=orphan_tender_daemons.js.map