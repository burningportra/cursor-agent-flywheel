...
export function recommendComposition(openBeadCount) {
 ...
 */
export function generateAgentConfigs(count, cwd, composition) {
    const configs = [];
 ...
 */
export function formatSwarmStatus(agents, beads) {
    if (agents.length === 0)
        return "No swarm agents active.";
 ...
 */
export function formatLaunchInstructions(configs) {
    const lines = [
