 ...
 *     catch.
 */
import { FLYWHEEL_ERROR_CODES, DEFAULT_HINTS, DEFAULT_TRY_THIS, type FlywheelErrorCode, type ErrorMeta } from './errors.js';
export { DEFAULT_HINTS, DEFAULT_TRY_THIS, FLYWHEEL_ERROR_CODES, type FlywheelErrorCode, type ErrorMeta, };
export declare const ERROR_META: Record<FlywheelErrorCode, ErrorMeta>;
