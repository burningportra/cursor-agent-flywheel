...
describe('chaos/remediate-kill-midrun', () => {
    ...
    it('aborting mid-execute cleans up lock; subsequent call succeeds', async () => {
        ...
        try {
            ...
            const inflight = runRemediate({ cwd, checkName: 'dist_drift', autoConfirm: true, mode: 'execute' }, exec, ac.signal);
            ...
            const followup = await runRemediate({ cwd, checkName: 'dist_drift', autoConfirm: true, mode: 'execute' }, okExec, ac2.signal);
...
//# sourceMappingURL=remediate-kill-midrun.test.js.map