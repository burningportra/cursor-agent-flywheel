...
import { runDoctorChecks, DOCTOR_CHECK_NAMES, } from '../../tools/doctor.js';
...
describe('chaos/doctor-kill-midrun', () => {
    ...
    it('partial report never contains undefined check names', async () => {
        ...
        try {
            ...
            const knownNames = new Set(DOCTOR_CHECK_NAMES);
...
//# sourceMappingURL=doctor-kill-midrun.test.js.map