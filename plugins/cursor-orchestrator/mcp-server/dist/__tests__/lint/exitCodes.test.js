...
import { computeExitCode, EXIT_CLEAN, EXIT_FINDINGS, EXIT_INTERNAL, EXIT_INVALID_ARGS, EXIT_FILE_ERROR, } from "../../lint/exitCodes.js";
function f(severity) {
...
describe("computeExitCode", () => {
    ...
    it("EXIT_FINDINGS (1) for a single error finding", () => {
        const r = { findings: [f("error")], internalErrors: [] };
    ...
    it("EXIT_CLEAN (0) for warn-only findings (warnings don't fail CI)", () => {
        const r = { findings: [f("warn"), f("info")], internalErrors: [] };
        expect(computeExitCode(r)).toBe(EXIT_CLEAN);
    });
...
//# sourceMappingURL=exitCodes.test.js.map