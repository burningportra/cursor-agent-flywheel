...
import { buildStartMenu, inferStartMenuVariant, FRESH_EYES_REVIEW_OPTION, RESEARCH_REPO_OPTION, } from "../../cursor-start-menu.js";
describe("flywheel_start_menu builders", () => {
    it("infers previous-session-exists from checkpoint phase", () => {
        expect(inferStartMenuVariant({
            hasCheckpoint: true,
    ...
    it("open-beads and previous-session menus include Fresh-eyes review and Research repo", () => {
        for (const variant of ["open-beads-exist", "previous-session-exists"]) {
...
//# sourceMappingURL=start-menu.test.js.map