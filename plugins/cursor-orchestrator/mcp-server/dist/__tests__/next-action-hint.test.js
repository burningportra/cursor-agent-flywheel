...
import { HINT_MAX_CHARS, buildAdvanceWaveHint, buildDispatchImplTasksHint, buildNextActionHint, buildQueueDrainedHint, buildWaveCompleteHint, } from '../next-action-hint.js';
...
describe('next-action-hint', () => {
    ...
    it('buildDispatchImplTasksHint truncates long text to cap', () => {
        const hint = buildDispatchImplTasksHint(0, 999, Array.from({ length: 60 }, (_, i) => `very-long-bead-id-${i}`));
        expect(hint.text.length).toBeLessThanOrEqual(HINT_MAX_CHARS);
    });
...
//# sourceMappingURL=next-action-hint.test.js.map