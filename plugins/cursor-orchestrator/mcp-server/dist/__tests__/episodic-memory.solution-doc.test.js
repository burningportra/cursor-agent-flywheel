...
import { draftSolutionDoc, draftPostmortem, } from '../episodic-memory.js';
import { SolutionDocSchema, renderSolutionDoc, inferSolutionCategory, } from '../solution-doc-schema.js';
// ─── Mock agent-mail ───────────────────────────────────────────
...
describe('draftSolutionDoc', () => {
    ...
    it('stale checkpoint warning routes to problem_type=stale_checkpoint', async () => {
        const { exec } = makeExec([
            // sha lookup fails
            {
                match: (cmd, args) => cmd === 'git' && args[0] === 'cat-file' && args[2] === 'deadbeef',
...
//# sourceMappingURL=episodic-memory.solution-doc.test.js.map