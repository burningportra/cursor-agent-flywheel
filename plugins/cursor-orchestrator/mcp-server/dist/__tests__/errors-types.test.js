...
import { ERROR_META, FLYWHEEL_ERROR_CODES, } from '../errors-try-this.js';
/**
...
describe('ERROR_META type-level coverage (T1.2)', () => {
    it('is exhaustively typed against FlywheelErrorCode', () => {
        const _coverageCheck = ERROR_META;
        expectTypeOf(_coverageCheck).toEqualTypeOf();
    ...
    it('every code in ERROR_META is a known FlywheelErrorCode (no orphans)', () => {
        const codes = new Set(FLYWHEEL_ERROR_CODES);
...
//# sourceMappingURL=errors-types.test.js.map