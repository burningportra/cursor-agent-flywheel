...
import { detectInstallState, REQUIRED_CLIS, } from '../setup-detector.js';
...
describe('detectInstallState (T3.1)', () => {
    ...
    it('flags missing NTM projects_base symlink into configure', async () => {
        ...
        const configureEntry = plan.configure.find((s) => s.startsWith('projects_base symlink:'));
...
//# sourceMappingURL=setup-detector.test.js.map