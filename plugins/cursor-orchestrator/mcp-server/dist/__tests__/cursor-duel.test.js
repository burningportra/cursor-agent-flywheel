...
import { buildCursorDuelRun, buildDuelModelsGate, getCursorDuelModels, resolveDuelModelsConfirm, } from '../cursor-duel.js';
describe('cursor-duel', () => {
    ...
    it('reads duel section from flywheel.config.yaml', () => {
        writeFileSync(join(tmp, 'flywheel.config.yaml'), `duel:
  wizard_a: model-a
  wizard_b: model-b
  wizard_c: model-c
  synthesis: model-s
...
//# sourceMappingURL=cursor-duel.test.js.map