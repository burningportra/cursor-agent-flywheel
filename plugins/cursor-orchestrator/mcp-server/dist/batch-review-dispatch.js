...
export function batchReviewVerdictPath(cwd, shaRange) {
    return path.join(cwd, batchReviewVerdictRel(shaRange));
}
export async function resolveHeadSha(cwd, exec) {
...
export function buildShaRange(fromSha, toSha) {
...
export async function prepareBatchReviewDispatch(ctx, shaRange, reviewSha) {
...
//# sourceMappingURL=batch-review-dispatch.js.map