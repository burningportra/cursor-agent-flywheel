 ...
 */
export function extractBeadFiles(bead) {
 ...
 */
export function countUncertaintySignals(text) {
 ...
 */
export function detectSpaceViolations(bead, summary, feedback, filesChanged) {
    const violations = [];
 ...
 */
export function formatSpaceViolations(violations) {
...
//# sourceMappingURL=space-detector.js.map