...
function buildReservationStep(bead: BeadDispatchContext, mode: ClaudePromptMode): string[] {
  const seedPaths =
...
function buildGitWorkflowStep(bead: BeadDispatchContext, mode: ClaudePromptMode): string[] {
  if (mode !== 'single-branch') {
