import type { Rule, Finding, RuleContext, Document, ParsedDocument } from "../types.js";
import type { SkillRegistry } from "../skillRegistry.js";

export interface SlashReferencesContext extends RuleContext {
  registry: SkillRegistry;
}

export const slash001: Rule = {
  id: "SLASH001",
