...
describe('runApprove — action=remediate', () => {
  let runApproveR: Awaited<ReturnType<typeof importApprove>>;
  ...
  function makeRemediation(overrides: Partial<NonNullable<Parameters<typeof runApproveR>[1]['remediation']>> = {}) {
    return {
